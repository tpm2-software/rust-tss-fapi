...
mod tests {
    ...
    #[test]
    fn test_u64_from_be() {
        assert_eq!(u64_from_be(&[0x11_u8, 0x22_u8, 0x33_u8, 0x44_u8, 0x55_u8, 0x66_u8, 0x77_u8, 0x88_u8,]), 0x1122334455667788_u64);
        assert_eq!(u64_from_be(&[0x88_u8, 0x77_u8, 0x66_u8, 0x55_u8, 0x44_u8, 0x33_u8, 0x22_u8, 0x11_u8,]), 0x8877665544332211_u64);
    }
