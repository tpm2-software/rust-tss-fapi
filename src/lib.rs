...
//! [![Rust](https://img.shields.io/badge/rust-1.86.0+-orchid?logo=rust)](https://www.rust-lang.org/)
...
//!
//! The **`tss2-fapi-rs`** Rust crate provides an interface to the [**TCG TSS 2.0 Feature API (FAPI)**](https://github.com/tpm2-software/tpm2-tss#overview).
//!
...
compile_error!("Sorry, this project currently only supports the Unix family of platforms.");
...
pub use callback::{AuthCbParam, BranchCbParam, Callbacks, Cancelled, CbResult, FapiCallbacks, PolicyActionCbParam, SignCbParam};
...
pub use types::{FapiPollHandle, ImportData, QuoteResult, SealedData, SignResult, TctiOpaqueContextBlob, TpmBlobs};
